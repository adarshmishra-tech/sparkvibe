  ...
  new Chart(ctx, {
    ...
    options: {
      ...
      scales: {
        y: {
          beginAtZero: true,
          title: { display: true, text: 'Feature Count', color: '#F5F5F5' },
          grid: { color: 'rgba(255, 215, 0, 0.1)' },
          ticks: { color: '#F5F5F5' }
        },
        x: {
          title: { display: true, text: 'Plan', color: '#F5F5F5' },
          ticks: { color: '#F5F5F5' }
        }
      }
    }
